...
const SearchPage = () => {
    ...
    const handleSearch = async (e) => {
        ...
        try {
            ...
            else{toast.error('An error occure, please try again later')}
  ...
  return (
    ...
    <div className='container mx-auto px-4 py-8'>
        ...
        <form className='flex gap-2 items-stretch mb-8 max-w-2xl mx-auto' onSubmit={handleSearch}>
            <input type='text' placeholder={'Search for a '+ activeTab} className='flex-1 py-2 px-4 rounded bg-gray-800 text-white' value={searchTerm} onChange={(e) => setSearchTerm(e.target.value)} />
